...
**Walks:** 1 (four lenses complete + a1 apart), each phase its own turn under CEO direction, per-phase committed. ⚠️ This header lagged the lenses until a1's record read — the fourth artifact running in which this exact header decayed; the class is proposal 258's evidence, sitting in the very batch this plan routes.
