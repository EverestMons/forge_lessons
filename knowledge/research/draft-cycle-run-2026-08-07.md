...
**Closing:** not reached — the last event is walk 2's culmination (a fold); a second ACID pass and the cold panel are owed; not deposited. ⚠️ Walk 2's yield came entirely from rotation: all six findings sit in the front matter or in prose describing earlier folds — regions the step-machinery walks never re-read.
