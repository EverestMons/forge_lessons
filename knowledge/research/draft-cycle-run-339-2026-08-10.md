...
> 3. **The Gate-2 queue check — ID-FOR-ID against Step 1 Receipt item 5's recorded list, never a count.** Any recorded id absent from the live set → the causal adjudication, whatever the count reads.
