...
| 11 | 2026-08-10 | - `_TERMINAL_STATUSES` omits `accepted`, so an ingest can silently stale a routed-but-not-yet-codified proposal; this plan carried 42 such rows and guarded them procedurally — worth deciding whether the guard belongs in the code instead. | deferred-work | — | open |
