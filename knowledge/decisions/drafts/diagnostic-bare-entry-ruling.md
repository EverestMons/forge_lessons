...
**Depends on:** `Done/diagnostic-501.md` and its mapping `knowledge/research/annotation-mapping-2026-08-22.tsv` (the quarantine list); `Done/diagnostic-504.md` and `knowledge/research/promotion-corrected-2026-08-23.md` (the two grading rules); `governance/knowledge/decisions/Done/executable-502.md` (which quarantined these 14 by construction) and `Done/executable-505.md` (which set the current state). Newest same-class and clone origin: **`Done/diagnostic-504.md`**, shipped 2026-08-23.
...
| id | pin | value | probe |
|---|---|---|---|
| D0 | **`Q`** — bare headings, this plan's whole subject | **14** | `D1` − `D5` |
